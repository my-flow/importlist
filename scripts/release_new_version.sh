...
DICT_FILE=${DICT_FILE:-"core/src/main/resources/com/moneydance/modules/features/importlist/meta_info.dict"}
...
patch_changelog_and_dictionary() {
  ...
  printf "[v%s]: https://github.com/my-flow/importlist/compare/v%s...v%s\n" \
